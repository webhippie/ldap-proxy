# Contributing to LDAP Proxy

Welcome! Our community focuses on helping others and making LDAP Proxy the best it
...
If unique, [open an issue](https://github.com/webhippie/ldap-proxy/issues)
and answer the questions so we can understand and reproduce the problematic
behavior.

The burden is on you to convince us that it is actually a bug in LDAP Proxy. This
...
Please be kind, remember that LDAP Proxy comes at no cost to you, and you're
getting free help.
...
resolving issues as you are able to. Thanks for making LDAP Proxy amazing!
...
Thanks for your help! LDAP Proxy would not be what it is today without your
contributions.
